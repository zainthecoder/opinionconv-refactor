                ...
                if aspects:
                    for aspect, polarity in zip(aspects, sentiments):
                        ...
                        if aspect is not None and aspect not in wrong_aspects and str(polarity).lower() == 'positive':
                            Opos1B = random.choice(Opos1B_list).format(item,aspect) + review
    ...
    if len(retrieved_items_with_review) > 0:
        for item in retrieved_items_with_review:
            if item not in done_items_pos:
                ...
                item_data['Opos1B_Opos1B2_only_agreement'] = blocks_Opos1B_Opos1B2_only_agreement
                ...
                item_data['Opos1B_Opos1B2_agreement_and_more'] = blocks_Opos1B_Opos1B2_agreement_and_more
