...
csv_input_path = (
    "./reviews_for_cellPhones_df_cleaned.csv"  # Path to your input CSV file
)
csv_output_path = (
    "./final_reviews_for_cellPhones_punctuated.csv"  # Path to save the output CSV file
)
...
if "text" in reviews_df.columns:
    ...
    for idx, row in reviews_df.iterrows():
        ...
        if (
            pd.notna(review_text) and review_text.strip()
