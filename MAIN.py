...
# df_metaData_concat_cellPhones["price"] = df_metaData_concat_cellPhones["price"].astype(
#     str
# )
...
# print("##TWOO##")
# pprint.pprint(Cell_Phones_df_raw.head(3))
...
# print(Cell_Phones_df_raw.iloc[0])
# pprint.pprint(Cell_Phones_df_raw.details.Brand)
